...
int main(int argc, char *argv[]) {
    ...
    while (true) {
        ...
        if (c == char_traits<int>::eof())
            break;
        int idx = (int(c) & 0xff);
        int code_point = KOI8_UNICODE[idx];
        if (!output_utf8(*out, code_point)) {
...
static void printHelp() {
    cout << "Convert a text file from Russian KOI8-R encoding to UTF8." << endl;
    cout << "Usage:" << endl;
    cout << "    koi2utf [fileIn [fileOut]]" << endl;
